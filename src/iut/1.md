...
<html>
    ...
    <body>
        ...
        <?php foreach ($cities as $cityId => $city) : ?>
            <tr>
                <td><a href="/tp1/public/city.php?id=<?= $cityId; ?>"><?= $city['name']; ?></a></td>
                <td><?= $city['country']; ?></td>
            </tr>
        <?php endforeach; ?>
        </table>
...
Open
[http://localhost:8080/tp1/public/cities.php](http://localhost:8080/tp1/public/cities.php).
...
<html>
    ...
    <body>
        ...
        <footer>
            <a href="/tp1/public/cities.php">Back to list</a>
        </footer>
    </body>
</html>
```
...
Open
[http://localhost:8080/tp1/public/city.php?id=-1](http://localhost:8080/tp1/public/city.php?id=-1)
and see the result.
