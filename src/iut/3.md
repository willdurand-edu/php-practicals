...
**U**pdate, and **D**elete tweets. This is called a **CRUD** application.
...
**Your teacher MUST validate your plan.**


2 - Create Routes and Templates
-------------------------------
...
First, try to list all statuses. Then, write a new controller to list a specific
status, identified by an `id` parameter. You should write two templates, one
for the list view, another one for the detail view.
...
Concerns**: it is Request's responsability to determine the _method_ used by the
client.
