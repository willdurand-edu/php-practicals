...
the best format for a client. You can take a look at these two RFCS:

* [RFC 2616: HTTP/1.1](http://pretty-rfc.herokuapp.com/RFC2616);
* [RFC 2295: content negotiation](http://pretty-rfc.herokuapp.com/RFC2295).
...
Also, try to create new statuses using JSON:
    ...
    $ curl -XPOST -H "Accept: application/json" -H 'Content-Type: application/json' -d '{"message": "Paris"}' http://localhost:8082/statuses
